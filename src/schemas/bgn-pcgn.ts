...
const PREV_MAPPING_ALT = new Map<string, string>([
    // е
    ["е", "ye"],
    ["ае", "ye"],
    ["ее", "ye"],
...
export const BGN_PCGN = new Schema(MAPPING, PREV_MAPPING, NEXT_MAPPING);
export const BGN_PCGN_ALT = new Schema(MAPPING, PREV_MAPPING_ALT);
